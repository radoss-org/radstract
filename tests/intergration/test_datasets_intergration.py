...
def test_polygon_dataset(dataset_dir):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        temp_dir_files = os.listdir(f"{temp_dir}/labels/train")
        test_dir_files = os.listdir(f"{TEST_DIR_POLYGON}/labels/train")
        temp_dir_files.sort()
        test_dir_files.sort()
...
def test_huggingface_dataset(dataset_dir):
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        temp_dir_files = os.listdir(f"{temp_dir}/labels/train")
        test_dir_files = os.listdir(f"{TEST_DIR_HUGGINGFACE}/labels/train")
        temp_dir_files.sort()
        test_dir_files.sort()
